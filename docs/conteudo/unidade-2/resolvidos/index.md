...
- Interpretar problemas com condicionais
- Entregar respostas a depender de condições
- Analisar estruturas de decisão corretamente
...
| Tema | Descrição |
|------|-----------|
| [Exercício com entrada de texto](./problema.md) | Problema ["Idade de Camila"](https://olimpiada.ic.unicamp.br/pratique/pj/2021/f1/idade/) |
